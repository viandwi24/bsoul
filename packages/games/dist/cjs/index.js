...
function Hello(_a) {
    var name = _a.name;
    return (jsxRuntime.jsx("div", { children: jsxRuntime.jsxs("p", { children: ["Hello, ", name] }) }));
}
...
function PreloadSceneUI(_a) {
    var scene = _a.scene;
    var signature = react.useState(Math.random().toString(36).substring(7))[0];
    var _b = react.useState([]), phaserobjects = _b[0], setPhaserobjects = _b[1];
    ...
    return (jsxRuntime.jsxs("div", __assign({ 
        ...
        style: {
            ...
            color: 'white',
        } }, { children: [jsxRuntime.jsxs("div", { children: ["BSOUL v0.0.1 (Demo vers. ", signature, ") ", jsxRuntime.jsx("button", __assign({ onClick: function () { return scene.game.gameClient.restart(); } }, { children: "Restart" }))] }), jsxRuntime.jsxs("div", { children: [jsxRuntime.jsx("div", __assign({ style: { fontWeight: 700 } }, { children: "GAMEOBJECTS" })), jsxRuntime.jsx("div", __assign({ style: { fontSize: '14px' } }, { children: phaserobjects.map(function (phaserobject) { return (jsxRuntime.jsxs("div", { children: [phaserobject.name, " (", phaserobject.type, ")"] }, Math.random())); }) }))] })] })));
}
var DemoScene = /** @class */ (function (_super) {
    ...
    DemoScene.prototype.preload = function () {
        // create react ui
        createReactUi(this, jsxRuntime.jsx(PreloadSceneUI, { scene: this })).render();
    };
...
exports.Hello = Hello;
exports.gameClientDefaultConfig = gameClientDefaultConfig;
