...
export class Tilemap {
  ...
  constructor(public scene: Phaser.Scene, public key: string, url: string) {
    ...
    loader.once(Phaser.Loader.Events.FILE_COMPLETE, (fKey: string, fType: string, file: any) => {
  ...
  preUpdate(time: number, delta: number) {
    this.gameobjects.forEach((obj) => obj.preUpdate.bind(obj)(time, delta))
  }
  ...
  postUpdate(time: number, delta: number) {
    this.gameobjects.forEach((obj) => obj.postUpdate.bind(obj)(time, delta))
  }
